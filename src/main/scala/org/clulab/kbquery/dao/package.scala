...
package object dao {
  ...
  type EntryType = Tuple10[Int, String, String, Boolean, Boolean, String, Int, Int, Int, Int]
  // type EntryRepType = Rep[EntryType]

  /** Type declaration for a row in the Slick-based Labels table. */
  type LabelType = Tuple2[Int, String]
  // type LabelRepType = Rep[LabelType]

  /** Type declaration for a row in the Slick-based Namespaces table. */
  type NamespaceType = Tuple2[Int, String]
  // type NamespaceRepType = Rep[NamespaceType]
