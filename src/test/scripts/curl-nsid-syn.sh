...
curl -s 'http://localhost:8888/kblu/byId?id=Q99683' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=Q13131' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=Q02750' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=P36507' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=P01116' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=Q9P0J7' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=P15056' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=6830' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=16666708' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=441276' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=PF01756' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=PF00091' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=PF00110' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=PF04901' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=3702' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=10029' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=36278' | wc
...
curl -s 'http://localhost:8888/kblu/byId?id=10116' | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "Q99683"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "Q13131"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "Q02750"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "P36507"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "P01116"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "Q9P0J7"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "P15056"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "6830"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "16666708"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "441276"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "PF01756"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "PF00091"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "PF00110"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "PF04901"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "3702"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "10029"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "36278"}' -H "$PTYPE" | wc
...
curl -s -XPOST 'http://localhost:8888/kblu/byId'      -d'{"id": "10116"}' -H "$PTYPE" | wc
